# This Makefile is for the App::Config extension to perl.
#
...
#     ABSTRACT => q[Easy configuration base class for your App.]
#     AUTHOR => q[John Cappiello <jcap@cpan.org>]
#     DIR => []
#     DISTNAME => q[App-Config]
#     NAME => q[App::Config]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], File::HomeDir=>q[0], Class::Default=>q[0], Class::Accessor=>q[0] }
#     VERSION => q[0.01]
...
TO_INST_PM = lib/App/Config.pm

PM_TO_BLIB = lib/App/Config.pm \
	blib/lib/App/Config.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/App/Config.pm $(INST_MAN3DIR)/App::Config.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/App/Config.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Easy configuration base class for your App.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>John Cappiello &lt;jcap@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-Accessor" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-Default" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="File-HomeDir" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/App/Config.pm blib/lib/App/Config.pm 
	$(NOECHO) $(TOUCH) $@
